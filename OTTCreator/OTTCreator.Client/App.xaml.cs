...
namespace OTTCreator.Client
{
    public partial class App : Application
    {
        ...
        private async Task GetTestData()
        {
            ...
            await clientDatabase.SaveItemAsync(contentItemForCreate);
            contentItemForCreate = new ContentItem() { Name = "Test content 5", Category = "Test category C", Type = "Test type II", Image = new System.Uri("https://cdn.pixabay.com/photo/2023/04/11/22/08/flower-7918323_960_720.jpg"), Stream = new System.Uri("http://radio.ukr.radio:8000/ur1-lv-mp3") };
            await clientDatabase.SaveItemAsync(contentItemForCreate);
            contentItemForCreate = new ContentItem() { Name = "Test content 6", Category = "Test category C", Type = "Test type II", Image = new System.Uri("https://cdn.pixabay.com/photo/2023/04/11/22/08/flower-7918323_960_720.jpg"), Stream = new System.Uri("http://icecast.luxnet.ua/luxlviv") };
            await clientDatabase.SaveItemAsync(contentItemForCreate);
            contentItemForCreate = new ContentItem() { Name = "Test content 7", Category = "Test category D", Type = "Test type II", Image = new System.Uri("https://cdn.pixabay.com/photo/2023/04/11/22/08/flower-7918323_960_720.jpg"), Stream = new System.Uri("http://radio.ukr.radio:8000/ur1-lv-mp3") };
            await clientDatabase.SaveItemAsync(contentItemForCreate);
            contentItemForCreate = new ContentItem() { Name = "Test content 8", Category = "Test category D", Type = "Test type II", Image = new System.Uri("https://cdn.pixabay.com/photo/2023/04/11/22/08/flower-7918323_960_720.jpg"), Stream = new System.Uri("http://icecast.luxnet.ua/luxlviv") };
            await clientDatabase.SaveItemAsync(contentItemForCreate);
        }
    }
}
